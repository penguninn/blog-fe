  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <Button
        ...
        className={
          editor.isActive("underline") ? "bg-gray-500 hover:bg-gray-500" : ""
        }
      >
        U
      </Button>
      ...
      <Button
        ...
        className={
          editor.isActive("codeBlock") ? "bg-gray-500 hover:bg-gray-500" : ""
        }
      >
        Code
      </Button>
      ...
      <Button
        ...
        className={
          editor.isActive("blockquote") ? "bg-gray-500 hover:bg-gray-500" : ""
        }
      >
        "Quote"
      </Button>
